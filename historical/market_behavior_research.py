...
def research_index(
    ...
    # --------------------------------------------------
    from historical.phase4_cluster_engine import run_phase4
    ...
    # --------------------------------------------------
    from historical.phase5_formation_engine import run_phase5
    ...
    # --------------------------------------------------
    # PHASE-6 QUALITY TIER / TIME / DIRECTION / BIG-MOVE
    # --------------------------------------------------
    from historical.phase6_quality_engine import run_phase6
    ...
    # --------------------------------------------------
    # PHASE-7 A+ VALIDATION / STABILITY / WALK-FORWARD
    # --------------------------------------------------
    from historical.phase7_validation_engine import run_phase7
    ...
    # --------------------------------------------------
    # PHASE-8 A+ FORMATION CONFIRMATION
    # --------------------------------------------------
    from historical.phase8_option_confirmation_engine import run_phase8
