    ...
    while True:
        ...
        for name in ["NIFTY","SENSEX"]:
            ...
            # ENTRY only if there was NO active trade at start of this cycle
                ...
                if ce_entry_confirmed and ce_no_chase and ai_direction == "BULLISH" and stable_direction == "BULLISH":
                    send(
                ...
                elif pe_entry_confirmed and pe_no_chase and ai_direction == "BEARISH" and stable_direction == "BEARISH":
                    send(
