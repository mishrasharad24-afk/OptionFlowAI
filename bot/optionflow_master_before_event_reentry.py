...
def scanner(token):
    ...
    while True:
        ...
        for name in ["NIFTY","SENSEX"]:
            ...
            # ===== FRESH SETUP RE-ENTRY GATE =====
            # 10 minutes is only the minimum waiting period.
            # After 10 minutes release the internal trade lock,
            # but DO NOT arm or signal in this same scanner cycle.
