    ...
    while True:
        ...
        for name in ["NIFTY","SENSEX"]:
            ...
            # ENTRY only if there was NO active trade at start of this cycle
                ...
                if ce_score >= 70 and ai_direction == "BULLISH" and stable_direction == "BULLISH" and ce_move > 0:
                    send(
                ...
                elif pe_score >= 70 and ai_direction == "BEARISH" and stable_direction == "BEARISH" and pe_move > 0:
                    send(
